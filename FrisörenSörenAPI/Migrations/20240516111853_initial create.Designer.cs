...
namespace FrisörenSörenAPI.Migrations
{
    ...
    [Migration("20240516111853_initial create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FrisörenSörenModels.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartTime = new DateTime(2024, 6, 1, 13, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            BookingId = 2,
                            CompanyId = 1,
                            CustomerId = 2,
                            EndTime = new DateTime(2024, 6, 1, 15, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CompanyId = 1,
                            CustomerId = 5,
                            EndTime = new DateTime(2024, 6, 1, 13, 0, 0, 0, DateTimeKind.Unspecified),
                            StartTime = new DateTime(2024, 6, 1, 12, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });

            modelBuilder.Entity("FrisörenSörenModels.ChangeLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FrisörenSörenModels.Company", b =>
                {
                    b.Property<int>("CompanyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FrisörenSörenModels.Customer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FrisörenSörenModels.Booking", b =>
                {
                    b.HasOne("FrisörenSörenModels.Company", "Company")
                        .WithMany("Bookings")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FrisörenSörenModels.Customer", "Customer")
                        .WithMany("Bookings")
